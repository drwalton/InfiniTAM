...
template<>
_CPU_AND_GPU_CODE_ inline void combineVoxelColorInformation(const CONSTPTR(ITMVoxel_s_rgbf) & src, DEVICEPTR(ITMVoxel_s_rgbf) & dst, int maxW)
{
	int newW = dst.w_color;
	int oldW = src.w_color;
	Vector3f newC = dst.clr;
	Vector3f oldC = src.clr;
